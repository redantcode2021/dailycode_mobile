...
import 'package:foo_supabase/auth_states_supabase/auth.dart';
import 'package:foo_supabase/gen/assets.gen.dart';
import 'package:foo_supabase/utils/utils.dart';
      ...
      builder: (context, state) {
        return Padding(
          ...
          child: TextFormField(
            ...
            readOnly: state.status.isLoading,
            textInputAction: TextInputAction.next,
            onChanged: (companyName) => context
                .read<AccountBloc>()
                .add(AccountCompanyChanged(companyName)),
...
class _SignOutButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return OutlinedButton(
      ...
      onPressed: isLoading
          ? null
          : () => context.read<AccountBloc>().add(AccountSignOut()),
